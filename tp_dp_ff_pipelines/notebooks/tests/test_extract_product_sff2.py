...
from src.tp_utils.common import extract_product_sff2
...
def test_valid_input(mock_logger, spark):
    ...
    row = ("P123", "A B C D E F G H I J K", "LongName", 1)
    df_raw1 = create_df_raw1(spark, [row])
    df_max_lvl = create_df_max_lvl(spark, 10)

    result_df = extract_product_sff2(df_raw1, 1, 2, 3, 4, df_max_lvl)
...
def test_missing_columns(mock_logger, spark):
    ...
    with pytest.raises(Exception):
        extract_product_sff2(df_raw1, 1, 2, 3, 4, df_max_lvl)

...
from src.tp_utils.common import extract_product_ffs
...
def test_valid_input(mock_logger, spark):
    ...
    value = "L12345678901234567890123456789012345678901234567890123456789012345678901234567890"
    df_raw1 = create_df_raw1(spark, [value])
    df_max_lvl = create_df_max_lvl(spark, 1)

    result_df = extract_product_ffs(df_raw1, 1, 2, 3, 4, df_max_lvl)

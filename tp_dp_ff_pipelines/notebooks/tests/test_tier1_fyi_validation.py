...
from src.tp_utils.common import tier1_fyi_validation
...
class TestTier1FYIValidation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.notebook_name = "tier1_fyi_validation"
        self.validation_name = "Tier1 FYI Validation"
    ...
    @patch("src.tp_utils.common.bad_kpi_check", return_value=MagicMock())
    ...
    @patch("src.tp_utils.common.time_perd_class_codes_new", return_value="monthly")
    ...
    def test_successful_execution(
        self, mock_get_logger, mock_sanitize, mock_load_cntrt_lkp, mock_time_perd_class,
        mock_read_query, mock_mm_time_perd_assoc, mock_dq_query, mock_validation,
        mock_bad_kpi_check, mock_merge, mock_generate_report, mock_generate_formatting
    ):
        ...
        tier1_fyi_validation(self.validation_name, self.file_name, self.cntrt_id,
    ...
    def test_time_period_class_code_failure(
        self, mock_time_perd_class, mock_load_cntrt_lkp, mock_sanitize, mock_get_logger
    ):
        mock_cntrt_df = MagicMock()
        mock_cntrt_df.collect.return_value = [self.mock_contract_row()]
        mock_load_cntrt_lkp.return_value = mock_cntrt_df

...
### Catalog
* **cdl_tp_dev** - dev catalog
* **cdl_prod_dev** - prod catalog

### Schemas

* **tp_dp_ff_pipelines** - <business use schema>
## DDAPI
### Prod
...
Only after all CI steps are succesfull the first deployment step is run, wnich is the `Migrate Schema`. It runs all queries related to Unity Catalog defined in [ddl directory](/tp_dp_ff_pipelines/tp_dp_ff_pipelines/ddl) to set up the database on databricks.
